...
export function SideBar() {
  ...
  const entrypointChunks = useMemo(() => allChunks.filter(chunk => chunk.isEntry), [allChunks])
      ...
      <Drawer visible={drawerVisible} placement="left" onClose={() => updateDrawerVisible(false)} w="400px">
        <Drawer.Content>
          ...
          <div>
            ...
            <Spacer h="0.5" />
            <Select scale={0.75} placeholder="Select endpoints" multiple onChange={handleFilterByEntrypoints}>
